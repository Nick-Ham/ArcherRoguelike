...
func _generate_name() -> String:
	return "ChaseTarget %s" % LimboUtility.decorate_var(targetVar)
...
func _tick(_delta: float) -> Status:
	...
	var vectorToTarget : Vector2 = (targetAsCharacter.global_position - agentAsCharacter.global_position).normalized()
	controller.setNewInputDirection(vectorToTarget)
